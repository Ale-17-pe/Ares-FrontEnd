    ...
    return (
        <>
            <section
                className="hero"
                style={{
                    background: `linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.31)), url(https://image-cdn.essentiallysports.com/wp-content/uploads/WhatsApp-Image-2023-03-14-at-3.38.45-PM.jpeg?width=600) no-repeat center center/cover`,
                }}
            >
